...
<head>
    ...
    <meta name="description" content="SheStyle Boutique - Premium fashion clothing and accessories in Kyanja, Kampala. Discover the latest trends in women's fashion.">
    <meta name="keywords" content="boutique, fashion, clothing, accessories, women's fashion, Kampala, Kyanja, Uganda">
    <meta name="author" content="SheStyle Boutique">
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="info-items">
                    ...
                    <span class="info-item">
                        <i class="fas fa-phone"></i> +256 700 000000
                    </span>
                    <span class="info-item d-none d-lg-inline">
                        <i class="fas fa-envelope"></i> info@shestyle.com
                    </span>
                </div>
            </div>
